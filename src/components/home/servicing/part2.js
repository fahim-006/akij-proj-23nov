      ...
      <div className="row">
        <div className="col-lg-4 pb-4">
          <div
            ...
            className="servicingPart2BackgroundImg"
          >
            <h6 className="servicingPart2h6">battery</h6>
          </div>
        </div>
        <div className="col-lg-4 pb-4">
          <div
            style={{ backgroundImage: `url(${airCondition})` }}
            className="servicingPart2BackgroundImg"
          >
        ...
        <div className="col-lg-4 pb-4">
          <div
            style={{ backgroundImage: `url(${stearing})` }}
            className="servicingPart2BackgroundImg"
          >
        ...
        <div className="col-lg-4 pb-4">
          <div
            style={{ backgroundImage: `url(${engineManagement})` }}
            className="servicingPart2BackgroundImg"
          >
        ...
        <div className="col-lg-4 pb-4">
          <div
            style={{ backgroundImage: `url(${suspension})` }}
            className="servicingPart2BackgroundImg"
          >
