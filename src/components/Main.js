...
import MainTerms from "./pages/Terms/TermsMain";
  ...
  return (
    <div>
      <Switch>
        ...
        <Route
          path="/shaktiman_plus_24_feet"
          component={Shaktiman_Plus_24_Feet}
        />
        <Route
          path="/heavy_duty_cargo_truck"
          component={Heavy_Duty_Cargo_Truck}
        />
        <Route
          path="/heavy_duty_cargo_truck_23Ton"
          component={Heavy_Duty_Cargo_Truck_23}
        />
        ...
        <Route
          path="/construction_machinery"
          component={ConstructionMachinery}
        />
        ...
        <Route
          path="/commercial_vehicles_sidebar_mini_truck"
          component={CommercialVehicles}
        />
        ...
        <Route
          path="/special_vehicle_sidebar"
          component={Special_Purpose_Vehicles}
        />
        <Route path="/faq" component={MainFAQ} />
        <Route path="/termsandconditions" component={MainTerms} />
        <Route path="/privacypolicy" component={PrivacyPolicy} />
        <Route path="/rmc_sidebar" component={RMC} />
        <Route path="/concrete_sidebar" component={Concrete_Machinery} />
        <Route
          path="/construction_sidebar"
          component={Construction_Machinery}
        />
        <Route path="/forklit_sidebar" component={ForkLift_Sidebar} />
        <Route
          path="/electric_motorcycle_sidebar"
          component={Electric_Motorcycle_sidebar}
        />
        <Route
          path="/garage_equipment_sidebar"
          component={Garage_Equipment_sidebar}
        />
        <Route
          path="/motor_servicing_sidebar"
          component={Motor_Servicing_sidebar}
        />
