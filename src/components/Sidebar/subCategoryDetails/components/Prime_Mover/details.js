                    ...
                    <div className="productDetails__content">
                      <div className="top__product__content d-flex">
                        <div className="top__lft"><br/>
                            {/* add name here*/}
                          <h4>Prime Mover (Hati) 4x2</h4> <br/><br/><br/><br/>
                            {/*  add name here*/}
                        </div>
            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="right__spc">
                  ...
                  <div className="even__content">
                    <h3>ইঞ্জিন</h3>
                    <h3>YC6A260-33, ৬ ইন-লাইন,ওয়াটার কুলিং,ইজিআর, এয়ার ইন্টারকুলার, টার্বোচার্জড </h3>
                  </div>
                  <div className="even__content">
                    <h3> পাওয়ার</h3>
                  ...
                  <div className="even__content">
                    <h3>ক্লাচ</h3>
                    <h3> ৩৯৫  মি.মি , ড্রাই টাইপ, সিঙ্গেল প্লেট ড্রাই কয়েল স্প্রিং, ডায়াফ্রাম স্প্রিং ক্লাচ, হাইড্রলিক কন্ট্রোল্ড এয়ার  এডেড পাওয়ার অপারেটিং  </h3>
                  </div>
                  <div className="even__content">
                    <h3>স্টিয়ারিং</h3>
                  ...
                  <div className="even__content">
                    <h3>চলমান অবস্থা</h3>
                    <h3> বাংলাদেশি আবহাওয়া এবং রাস্তার  উপযোগী করে তৈরী যা বহন করতে পারে সকল ধরনের ট্রেইলর। </h3>
                  </div>
