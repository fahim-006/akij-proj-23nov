                    ...
                    <div className="productDetails__content">
                      <div className="top__product__content d-flex">
                        <div className="top__lft">
                          <br />
                          {/* add name here*/}
                          <h6>Rustom Cargo Truck 4x2 15 Ton Diesel</h6> <br />
                          <br />
                          <br />
                          <br />
                          {/*  add name here*/}
              ...
              <div className="col-lg-8">
                <div className="right__spc">
                  ...
                  <div className="even__content">
                    <h6>ইঞ্জিন</h6>
                    <h6>
                      ইউচাই YC4E160-33, ৪ সিলিন্ডার ইন-লাইন,ফোর স্টোক, ডায়রেক্ট
                      ইনজেকশন ডিজেল ইঞ্জিন, ওয়াটার কুলিং,ইন্টারকুলার,
                      টার্বোচার্জড{" "}
                    </h6>
                  </div>
                  <div className="even__content">
                  ...
                  <div className="even__content">
                    ...
                    <h6>
                      {" "}
                      ৩৫০ মিঃ মিঃ , সিঙ্গেল ড্রাই প্লেট ড্রাই কয়েল স্প্রিং,
                      হাইড্রলিকএয়ার এসিস্ট অপারেটিং{" "}
                    </h6>
                  </div>
                  <div className="even__content">
                    <h6>স্টিয়ারিং</h6>
                  ...
                  <div className="even__content">
                    ...
                    <h6>
                      {" "}
                      ২০৮০ মি.মি, স্লিপার কেবিন, ইন্টিগ্রেট ফ্রন্ট টিল্টেবল{" "}
                    </h6>
                  </div>
