                ...
                <div className="row d-flex ">
                  <div className="col-md-6">
                    <div className="productDetailsCard__img"><br/><br/>
                      <img src="images/Commercial_Vehicles/11.PNG" alt="" />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="productDetails__content">
                      <div className="top__product__content d-flex">
                        <div className="top__lft"><br/>
                            {/* add name here*/}
                          <h6>Rustom Cargo Truck 4x2 15 Ton Diesel</h6> <br/><br/><br/><br/>
                            {/*  add name here*/}
                        </div>
              ...
              <div className="col-lg-8">
                <div className="right__spc">
                  ...
                  <div className="even__content">
                                      <h6>মডেল</h6>
                                      <h6> 	রুস্তম ২০ ফুট চেসিস</h6>
                                    </div>
                  {/* add this portion if new specification is added*/}
                  <div className="even__content">
                    <h6>ইঞ্জিন</h6>
                    <h6>ইউচাই YC4E160-33, ৪ সিলিন্ডার ইন-লাইন,ফোর স্টোক, ডায়রেক্ট ইনজেকশন ডিজেল ইঞ্জিন, ওয়াটার কুলিং,ইন্টারকুলার, টার্বোচার্জড </h6>
                  </div>
                  <div className="even__content">
                  ...
                  <div className="even__content">
                    <h6> পাওয়ার</h6>
                    <h6> ১১৯ কিলো-ওয়াট (১৬০ হর্স পাওয়ার)  @ ২৬০০ আর পি এম</h6>
                  </div>
                  <div className="even__content">
                    <h6>টর্ক</h6>
                    <h6>৫২০ এন এম @ ১৩০০ - ১৭০০ আর পি এম</h6>
                  </div>
                  <div className="even__content">
                    <h6>পিস্টন ডিসপ্লেসমেন্ট</h6>
                    <h6> ৪২১৪  সিসি</h6>
                  ...
                  <div className="even__content">
                    <h6>গিয়ার</h6>
                    <h6>DC6J70TC (৬ ফরওয়ার্ড স্পীড +১ রিভার্স স্পীড) </h6>
                  </div>
                  <div className="even__content">
                    <h6>ক্লাচ</h6>
                    <h6> 	৩৫০ মিঃ মিঃ , সিঙ্গেল ড্রাই প্লেট ড্রাই কয়েল স্প্রিং, হাইড্রলিকএয়ার  এসিস্ট অপারেটিং </h6>
                  </div>
                  <div className="even__content">
                    <h6>স্টিয়ারিং</h6>
                  ...
                  <div className="even__content">
                    ...
                    <h6>দৈর্ঘ্য ২৭ ফুট x  প্রস্থ ৭.৭৮ ফুট x উচ্চতা ৮.৭৬ ফুট</h6>
                  </div>
                  <div className="even__content">
                  ...
                  <div className="even__content">
                    <h6>কেবিন</h6>
                    <h6> ২০৮০ মি.মি, স্লিপার কেবিন, ইন্টিগ্রেট ফ্রন্ট টিল্টেবল   </h6>
                  </div>
                 
                  <div className="even__content">
                    <h6>সর্বোচ্চ গতি</h6>
                    <h6> 	ঘণ্টায় ৯৫  কিঃমিঃ </h6>
                  </div>
                  <div className="even__content">
                    <h6>হুইলবেস</h6>
                    <h6> ৪৭০০ মিমি </h6>
                  ...
                  <div className="even__content">
                    <h6>ব্যাটারী</h6>
                    <h6>(২ x ১২) ২৪ ভোল্ট, ১০৫ এম্পিয়ার</h6>
                  </div>
                  <div className="even__content">
                    <h6>ড্রাইভিং</h6>
                    <h6>  	৪ x ২</h6>
...
export default Details_Rustom_20_Feet;