...
const Details_Heavy_Duty_Cargo_Truck = () => {
  return (
    <>
                    ...
                    <div className="productDetails__content">
                      <div className="top__product__content d-flex">
                        <div className="top__lft">
                          ...
                          {/* add name here*/}
                          <h6>
                            Heavy Duty Cargo Truck (Bahadur) 6x4 Diesel
                          </h6>{" "}
                          <br />
                          <br />
                          <br />
              ...
              <div className="col-lg-8">
                <div className="right__spc">
                  ...
                  <div className="even__content">
                    <h6>ইঞ্জিন</h6>
                    <h6>
                      উইচাই WP6.340E32, ৬ ইন-লাইন,ওয়াটার কুলিং,ইজিআর, এয়ার
                  ...
                  <div className="even__content">
                    ...
                    <h6>
                      {" "}
                      ৪৩০ মি.মি , ড্রাই টাইপ, সিঙ্গেল প্লেট ড্রাই কয়েল স্প্রিং,
                      ডায়াফ্রাম স্প্রিং ক্লাচ, হাইড্রলিক{" "}
                    </h6>
                  </div>
                  <div className="even__content">
                    <h6>স্টিয়ারিং</h6>
                  ...
                  <div className="even__content">
                    ...
                    <h6>
                      {" "}
                      বাংলাদেশের আবহাওয়া এবং রাস্তার উপযোগী করে তৈরী যা বহন করতে
                      পারে বালি,মাটি,পাথর,কয়লা।{" "}
                    </h6>
                  </div>
                </div>
              </div>
...
export default Details_Heavy_Duty_Cargo_Truck;
