              ...
              <div className="row d-flex ">
                <div className="col-md-6">
                  <div className="productDetailsCard__img"><br/><br/>
                    <img src="/images/Private_Vehicles/vip-a6-microbus.jpg" alt="" />
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="productDetails__content">
                    <div className="top__product__content d-flex">
                      <div className="top__lft"><br/>
                          {/* add name here*/}
                        <h6>VIP Microbus 5/8 Seats Diesel/Petrol</h6> <br/><br/><br/><br/>
                          {/*  add name here*/}
                      </div>
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="right__spc">
                ...
                <div className="even__content">
                  <h6>ব্রেক সিস্টেম</h6>
                  <h6> 	ABS+EBD, ডিস্ক / ড্রাম , ইনিসিয়েটিভ ভ্যাকুয়াম বুস্টার </h6>
                </div>
                <div className="even__content">
                  <h6>সাসপেনশন </h6>
                  <h6> 	সামনে ডাবল উইসবোন ইনডিপিন্ডেন্ট সাসপেনশন / পিছনে ভেরিয়েবল রেট লীফ স্প্রিং </h6>
                </div>
                <div className="even__content">
