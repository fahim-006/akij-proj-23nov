...
const Details_Shaktiman_Plus_24_Feet = () => {
  return (
    <>
                ...
                <div className="row d-flex ">
                  <div className="col-md-6">
                    <div className="productDetailsCard__img">
                      <img
                        src="images/Commercial_Vehicles/sino-220hp-truck.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                    ...
                    <div className="productDetails__content">
                      <div className="top__product__content d-flex">
                        <div className="top__lft">
                          <br />
                          {/* add name here*/}
                          <h6>Shaktiman Plus 24 Feet body</h6> <br />
                          <br />
                          <br />
                          <br />
                          {/*  add name here*/}
...
export default Details_Shaktiman_Plus_24_Feet;
