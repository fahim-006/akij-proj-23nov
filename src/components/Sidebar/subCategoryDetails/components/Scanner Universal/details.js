...
const Details_Scanner_Universal  = () => {
  return (
    <>
                  ...
                  <div className="productDetails__content">
                    <div className="top__product__content d-flex">
                      <div className="top__lft"><br/>
                          {/* add name here*/}
                        <h6>Scanner Universal</h6> <br/><br/><br/><br/>
                          {/*  add name here*/}
                      </div>
            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="right__spc">
                  ...
                  {/* add this portion if new specification is added*/}
                  <div className="even__content">
                    <h6>Working Temperature:</h6>
                    <h6>	-10 ℃ to 50℃ </h6>
                  </div>

                  <div className="even__content">
                    <h6>Display:</h6>
                    <h6>	10.1 inch, 1920*1200 </h6>
                  </div>
...
export default Details_Scanner_Universal;