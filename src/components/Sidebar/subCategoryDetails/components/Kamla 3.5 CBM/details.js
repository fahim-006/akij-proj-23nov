                ...
                <div className="row d-flex ">
                  <div className="col-md-6">
                    <div className="productDetailsCard__img"><br/><br/>
                      <img src="images/Commercial_Vehicles/kamla-35cbm-diesel.jpg" alt="" />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="productDetails__content">
                      <div className="top__product__content d-flex">
                        <div className="top__lft"><br/>
                            {/* add name here*/}
                          <h6>Kamla 3.5 CBM (ISUZU original) Dump Truck</h6> <br/><br/><br/><br/>
                            {/*  add name here*/}
                        </div>
            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="right__spc">
                  ...
                  <div className="even__content">
                    <h6>ইঞ্জিন</h6>
                    <h6>অরিজিনাল ইসুজু , JE493ZlQ3A, ৪ সিলিন্ডার,ভাটিকাল ইন-লাইন, ওয়াটার কুল, ইন্টারকুলার ও  রোটারি পাম্প টার্বোচার্জার </h6>
                  </div>
                  <div className="even__content">
