                    ...
                    <div className="row d-flex ">
                      <div className="col-md-6">
                        <div className="productDetailsCard__img"><br/><br/>
                          <img src="images/Commercial_Vehicles/sinotruck-4ton-diesel.jpg" alt="" />
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="productDetails__content">
                          <div className="top__product__content d-flex">
                            <div className="top__lft"><br/>
                                {/* add name here*/}
                              <h4>Rajdut 4.0 Ton Diesel</h4> <br/><br/><br/><br/>
                                {/*  add name here*/}
                            </div>
                ...
                <div className="row">
                  <div className="col-lg-8">
                    <div className="right__spc">
                      ...
                      <div className="even__content">
                        <h6>ইঞ্জিন</h6>
                        <h6>    ইসুজু, JE493ZlQ3A, ৪ সিলিন্ডার, ওয়াটার কুল, ইন্টার কুলার, টার্বো চার্জার</h6>
                      </div>
                      <div className="even__content">
                        <h6>পাওয়ার</h6>
                      ...
                      <div className="even__content">
                        <h6>সাসপেনশন</h6>
                        <h6>লিফ স্প্রিং, ফ্রন্ট ৬+ শক এবজার্বার, রিয়ার ৯+৫ শক এবজার্বার</h6>
                      </div>
                      <div className="even__content">
                      ...
                      <div className="even__content">
                        ...
                        <h6>দৈর্ঘ্য ৪২০০ মিঃমিঃ x প্রস্থ ২০৫০ মিঃমিঃ x উচ্চতা ৪০০ মিঃমিঃ</h6>
                      </div>
                      <div className="even__content">
                        <h6>টোটাল ডাইমেনশন</h6>
                        <h6>দৈর্ঘ্য ৫৯৯৭ মিঃমিঃ x প্রস্থ ২০৫০ মিঃমিঃ x উচ্চতা ২৩৬৫ মিঃমিঃ</h6>
                      </div>
                      <div className="even__content">
                        <h6>কার্বওয়েট</h6>
                        <h6> 	২৭৫০ কেজি</h6>
