                ...
                <div className="row d-flex ">
                  <div className="col-md-6">
                    <div className="productDetailsCard__img">
                      <img
                        src="images/Commercial_Vehicles/dump-truck-5cbm-birbol.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                    ...
                    <div className="productDetails__content">
                      <div className="top__product__content d-flex">
                        <div className="top__lft">
                          ...
                          {/* add name here*/}
                          <h6>
                            Dump Truck 3.5/5.0 CBM - Kamla Plus| Tipper
                          </h6>{" "}
                          <br />
                          <br />
                          <br />
              ...
              <div className="col-lg-8">
                <div className="right__spc">
                  ...
                  <div className="even__content">
                    <h6>ইঞ্জিন</h6>
                    <h6>
                      ইউচাই YC4D130-33, ৪ সিলিন্ডার ইন-লাইন,ফোর স্টোক,
                      ইজিআর,ইন্টারকুলার, টার্বোচার্জড{" "}
                    </h6>
                  </div>
                  <div className="even__content">
