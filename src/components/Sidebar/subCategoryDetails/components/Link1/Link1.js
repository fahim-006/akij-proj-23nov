                ...
                <div className="row d-flex ">
                  <div className="col-md-6">
                    <div className="productDetailsCard__img">
                      <img
                        src="/images/Commercial_Vehicles/mini_truck_pankhiuraj_1ton_duesel.PNG"
                        alt=""
                      />
                    </div>
                  </div>
                    ...
                    <div className="productDetails__content">
                      <div className="top__product__content d-flex">
                        <div className="top__lft">
                          ...
                          {/* add name here*/}
                          <h6>
                            AKIJ Pickup/Mini Truck (Ponkhiraj Plus) 1.2 Ton
                            Diesel
                          </h6>{" "}
                          <br />
                          <button className="show__spc__btn">
                            Show specifications
                          </button>
                          <br />
                          <br />
              ...
              <div className="col-lg-8">
                <div className="right__spc">
                  ...
                  <div className="even__content">
                    ...
                    <h6>
                      {" "}
                      সুজুকি টেকনোলজি, QC480Q, ভাটিকাল, ইন-লাইন ফোর সিলিন্ডার,
                      ফোর স্টোক,ডাইরেক্ট ইনজেকশন ।
                    </h6>
                  </div>
                  <div className="even__content">
                    <h6>পাওয়ার</h6>
                  ...
                  <div className="even__content">
                    ...
                    <h6>
                      দৈর্ঘ্য ২৯৩০ মিঃমিঃ x প্রস্থ ১৬১০ মিঃমিঃ x উচ্চতা ৩৬০
                      মিঃমিঃ
                    </h6>
                  </div>
                  <div className="even__content">
                    ...
                    <h6>
                      দৈর্ঘ্য ৪৬৩০ মিঃমিঃ x প্রস্থ ১৭৪০ মিঃমিঃ x উচ্চতা ২০৪০
                      মিঃমিঃ
                    </h6>
                  </div>
                  <div className="even__content">
