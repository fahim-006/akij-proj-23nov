...
const TwentyYearsExp = () =>{
    return(
        ...
        <div className="container-fluid" style={{backgroundColor:"#E3E3E3"}}>
            <div className="row">
                <div className="col-lg-6 col-md-12 col-sm-12" style={{textAlign: "center",marginTop: "350px"}}>
                    <h1>We are a team of handy<br/> mechanics with  more than<br/>  20 years experience.</h1>
